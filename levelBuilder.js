function BuildLevel(array1, array2, array3, topLeft){
    ...
    for (let i = 0; i < array1.length; i++) {
        if(array1[i] == 0){
            ...
            thing1 = new explosive.Sprite(array1Control, topLeft1, 40, 'k');
            thing2 = new explosiveCollider.Sprite(array1Control, 100, 40, 'd');
            thing2.overlaps(thing1);
        }
    ...
    for (let i = 0; i < array2.length; i++) {
        if(array2[i] == 0){
            ...
            thing1 = new explosive.Sprite(array2Control, topLeft2, 40, 'k');
            thing2 = new explosiveCollider.Sprite(array2Control, topLeft2, 40, 'd');
            thing2.overlaps(thing1);
        }
        array2Control += 60;
    }
    ...
    for (let i = 0; i < array3.length; i++) {
        if(array3[i] == 0){
            ...
            thing1 = new explosive.Sprite(array3Control, topLeft3, 40, 'k');
            thing2 = new explosiveCollider.Sprite(array3Control, topLeft3, 40, 'd');
            thing2.overlaps(thing1);
        }
        array3Control += 60;
    }
